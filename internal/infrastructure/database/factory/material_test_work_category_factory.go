...
type NewMaterialTestWorkCategoryFactoryParams struct {
	fx.In

	IdService id.IdService
}

func NewMaterialTestWorkCategoryFactory(params NewMaterialTestWorkCategoryFactoryParams) *factory.Factory {
	idService := params.IdService

	return factory.NewFactory(&entity.MaterialTestWorkCategory{}).
		...
		Attr("UpdatedAt", func(args factory.Args) (any, error) {
			createdAt := args.Instance().(*entity.MaterialTestWorkCategory).CreatedAt
