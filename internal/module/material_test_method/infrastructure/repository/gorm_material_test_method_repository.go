...
func (r *GormMaterialTestMethodRepository) Find(id string, q *query.Query) (mtm *entity.MaterialTestMethod, err error) {
	db := r.query(r.db, q)
...
func (r *GormMaterialTestMethodRepository) FindByName(name string, q *query.Query) (mtm *entity.MaterialTestMethod, err error) {
	db := r.query(r.db, q)
...
func (r *GormMaterialTestMethodRepository) FindByIds(ids []string, q *query.Query) (mtms []*entity.MaterialTestMethod, err error) {
	db := r.query(r.db, q)
