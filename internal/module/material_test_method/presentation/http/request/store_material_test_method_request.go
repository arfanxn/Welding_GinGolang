...
var _ request.Request = (*StoreMaterialTestMethod)(nil)

type StoreMaterialTestMethod struct {
	Name        string  `form:"name" json:"name"`
	Description *string `form:"description" json:"description"`
}

func NewStoreMaterialTestMethod() *StoreMaterialTestMethod {
	return &StoreMaterialTestMethod{}
}

func (s *StoreMaterialTestMethod) Validate() error {
