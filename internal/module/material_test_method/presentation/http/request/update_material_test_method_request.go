...
var _ request.Request = (*UpdateMaterialTestMethod)(nil)

type UpdateMaterialTestMethod struct {
	Id          string  `form:"id" json:"id"`
	Name        *string `form:"name" json:"name"`
	Description *string `form:"description" json:"description"`
}

func NewUpdateMaterialTestMethod() *UpdateMaterialTestMethod {
	return &UpdateMaterialTestMethod{}
}

func (s *UpdateMaterialTestMethod) Validate() error {
