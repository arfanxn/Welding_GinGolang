...
var _ request.Request = (*StoreCustomerRequest)(nil)
...
func NewStoreCustomerRequest() *StoreCustomerRequest {
	return &StoreCustomerRequest{}
}

func (r *StoreCustomerRequest) Validate() error {
