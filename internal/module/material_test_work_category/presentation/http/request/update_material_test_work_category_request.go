...
var _ request.Request = (*UpdateMaterialTestWorkCategory)(nil)

type UpdateMaterialTestWorkCategory struct {
	Id          string  `form:"id" json:"id"`
	Name        *string `form:"name" json:"name"`
	Description *string `form:"description" json:"description"`
}

func NewUpdateMaterialTestWorkCategory() *UpdateMaterialTestWorkCategory {
	return &UpdateMaterialTestWorkCategory{}
}

func (s *UpdateMaterialTestWorkCategory) Validate() error {
