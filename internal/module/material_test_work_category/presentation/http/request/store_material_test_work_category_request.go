...
var _ request.Request = (*StoreMaterialTestWorkCategory)(nil)

type StoreMaterialTestWorkCategory struct {
	Name        string  `form:"name" json:"name"`
	Description *string `form:"description" json:"description"`
}

func NewStoreMaterialTestWorkCategory() *StoreMaterialTestWorkCategory {
	return &StoreMaterialTestWorkCategory{}
}

func (s *StoreMaterialTestWorkCategory) Validate() error {
