...
var _ request.Request = (*StoreMaterialTestOrderService)(nil)
...
type StoreMaterialTestOrder struct {
	...
	OrderedServices []StoreMaterialTestOrderService `form:"ordered_services" json:"ordered_services"`
}
...
func (r *StoreMaterialTestOrder) Validate() error {
	return validation.ValidateStruct(r,
		...
		validation.Field(&r.ApplicantFullAddress,
			validation.Required.Error("Alamat pemohon wajib disi"),
		...
		validation.Field(&r.RecipientName,
			validation.Required.Error("Nama penerima wajib disi"),
		...
		validation.Field(&r.EnteredAt,
			validation.Required.Error("Tanggal waktu masuk wajib disi"),
		...
		validation.Field(
			...
			validation.Each(
				validation.By(func(value any) error {
					orderService := value.(StoreMaterialTestOrderService)
